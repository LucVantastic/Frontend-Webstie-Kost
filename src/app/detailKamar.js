...
export default function DetailKamarPage({ room, onNavigateToDashboard, onNavigateToKamar, onNavigateToBooking, onNavigateToContact, onNavigateToProfile, onLogout }) {
  if (!room) {
      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <div className="w-full lg:w-1/2 flex flex-col">
            ...
            <p className="text-2xl font-bold text-blue-600 mb-4">{room.price.replace('/bln', ' / bulan')}</p>
            ...
            <div className="mb-8">
              ...
              <p className="text-slate-500 leading-relaxed">
                Kamar nyaman dengan fasilitas lengkap dan lingkungan aman.
              </p>
            </div>

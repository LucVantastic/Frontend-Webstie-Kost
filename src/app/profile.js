...
export default function ProfilePage({ onNavigateToDashboard, onNavigateToKamar, onNavigateToContact, onLogout }) {
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="w-full lg:w-1/2 flex flex-col">
            ...
            <div className="flex gap-4">
              <button className="flex-1 bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3.5 rounded-xl transition-colors shadow-sm text-sm">
                Edit Profil
              </button>
              <button 
          ...
          <div className="w-full lg:w-1/2">
            <div className="bg-white p-8 rounded-2xl border border-slate-100 shadow-sm h-full flex flex-col">
              ...
              <div className="mb-4">
                <h3 className="font-bold text-slate-900 text-lg mb-1">Kamar A</h3>
                <p className="text-slate-500 text-sm mb-4">Tanggal masuk: 01 Juni 2026</p>
              ...
              <div className="mt-8">
                {/* <button className="text-blue-600 font-bold text-sm hover:text-blue-700 transition-colors bg-transparent border-none cursor-pointer p-0">
                  Lihat Detail
                </button> */}
              </div>
            </div>

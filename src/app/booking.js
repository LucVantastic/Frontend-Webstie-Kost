...
export default function BookingPage({ room, onNavigateToDashboard, onNavigateToKamar, onNavigateToDetail, onNavigateToContact, onNavigateToProfile, onLogout }) {
  ...
  const roomData = room || { name: 'Kamar Terpilih', price: 'Rp0/bln', status: 'Tersedia' };
          ...
          <div className="w-full lg:w-1/3 flex flex-col gap-6">
            ...
            <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm">
              ...
              <p className="text-slate-600 text-sm mb-3">
                {roomData.name} - {roomData.price.replace('/bln', '/bulan')}
              </p>

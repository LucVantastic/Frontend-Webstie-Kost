...
export default function DashboardPage({ onNavigateToProfile, onNavigateToKamar, onNavigateToDetail, onNavigateToContact }) {
  return (
      ...
      <main className="max-w-7xl mx-auto px-6 py-12">
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
          ...
          <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm flex flex-col justify-center h-28">
            ...
            <p className="text-slate-500 text-sm">Kamar nyaman & bersih</p>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-white p-5 rounded-2xl border border-slate-100 shadow-sm flex flex-col">
              ...
              <h3 className="font-bold text-slate-800 text-lg mb-1">Kamar A</h3>
              ...
              <div className="flex items-center justify-between mt-auto">
                ...
                <button 
                  onClick={() => onNavigateToDetail && onNavigateToDetail({ name: 'Kamar A', price: 'Rp700.000/bln', status: 'Tersedia' })}
            ...
            <div className="bg-white p-5 rounded-2xl border border-slate-100 shadow-sm flex flex-col">
              ...
              <h3 className="font-bold text-slate-800 text-lg mb-1">Kamar B</h3>
              <p className="text-blue-600 font-bold text-sm mb-4">Rp800.000/bln</p>
              <div className="flex items-center justify-between mt-auto">
                <span className="bg-green-500 text-white text-xs font-bold px-3 py-1.5 rounded-full">Tersedia</span>
                <button 
                  onClick={() => onNavigateToDetail && onNavigateToDetail({ name: 'Kamar B', price: 'Rp800.000/bln', status: 'Tersedia' })}
                  className="text-blue-600 font-bold text-sm hover:text-blue-700 transition-colors bg-transparent border-none cursor-pointer"
                >
                  Detail
                </button>
            ...
            <div className="bg-white p-5 rounded-2xl border border-slate-100 shadow-sm flex flex-col">
              ...
              <h3 className="font-bold text-slate-800 text-lg mb-1">Kamar C</h3>
              <p className="text-blue-600 font-bold text-sm mb-4">Rp900.000/bln</p>
              <div className="flex items-center justify-between mt-auto">
                <span className="bg-green-500 text-white text-xs font-bold px-3 py-1.5 rounded-full">Tersedia</span>
                <button 
                  onClick={() => onNavigateToDetail && onNavigateToDetail({ name: 'Kamar C', price: 'Rp900.000/bln', status: 'Tersedia' })}
                  className="text-blue-600 font-bold text-sm hover:text-blue-700 transition-colors bg-transparent border-none cursor-pointer"
                >
                  Detail
                </button>
            ...
            <div className="bg-white p-5 rounded-2xl border border-slate-100 shadow-sm flex flex-col">
              ...
              <h3 className="font-bold text-slate-800 text-lg mb-1">Kamar D</h3>
              <p className="text-blue-600 font-bold text-sm mb-4">Rp1000.000/bln</p>
              <div className="flex items-center justify-between mt-auto">
                <span className="bg-red-500 text-white text-xs font-bold px-3 py-1.5 rounded-full">Penuh</span>
                <button 
                  onClick={() => onNavigateToDetail && onNavigateToDetail({ name: 'Kamar D', price: 'Rp1000.000/bln', status: 'Penuh' })}
                  className="text-blue-600 font-bold text-sm hover:text-blue-700 transition-colors bg-transparent border-none cursor-pointer"
                >
                  Detail
                </button>
